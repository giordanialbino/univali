$(function(){
	...
	function Adicionar(){
		...
		var cliente = JSON.stringify({
			...
			Quantidade: $("#numQuantidade").val(),
			Preço    : $("#numPreco").val(),
			Perecível: $("#check").val(),
			Validade : $("#dataValidade").val(),
			Fabricação: $("#dataFabrica").val(),
		});
	...
	$("#tblListar").on("click", ".btnEditar", function(){
		...
		$("#numQuantidade").val(cli.Quantidade);
		$("#numPreco").val(cli.Preço);
		$("#Check").val(cli.Perecível);
		$("#dataValidade").val(cli.Validade);
		$("#dataFabrica").val(cli.Fabricação);
